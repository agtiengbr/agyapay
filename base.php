...
class BaseAgYapay extends AgPaymentModule
{
    ...
    public function resetConfig()
    {
        ...
        Configuration::updateValue('AGYAPAY_RESELLER_TOKEN', '');

        Configuration::updateValue('AGYAPAY_MAX_INTALLMENTS', 12);
        Configuration::updateValue('AGYAPAY_SANDBOX_ACCOUNT_TOKEN', '');
    ...
    */
    ...
    {
        $resellerToken = Configuration::get('AGYAPAY_RESELLER_TOKEN');
        if (empty($resellerToken) || $resellerToken == $accountToken) {
            return '';
        }
